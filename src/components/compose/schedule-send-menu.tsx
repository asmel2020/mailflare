...
const optionLabelKeys: Record<string, string> = {
	"Later today": "scheduleLaterToday",
	"Tomorrow morning": "scheduleTomorrowMorning",
	"Monday morning": "scheduleMondayMorning",
};
			...
			<DropdownMenu.Portal>
				...
				>
					...
					{options.map((option) => (
						...
						>
							{optionLabelKeys[option.label] ? t(optionLabelKeys[option.label]) : option.label}

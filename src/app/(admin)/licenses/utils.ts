...
export const LICENSE_PLANS: LicensePlan[] = [
	{
		...
		featureKeys: ["proFeatureBranding", "proFeatureFuture", "proFeatureUpdates", "proFeatureKeep"],
		icon: Sparkles,
	...
	},
	{
		...
		featureKeys: ["teamFeatureEverything", "teamFeatureAccounts", "teamFeatureShared", "teamFeatureUpdates", "teamFeatureKeep"],
		icon: Building2,
